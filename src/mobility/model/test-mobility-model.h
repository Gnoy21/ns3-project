...
#ifndef TEST_MOBILITY_MODEL_H
#define TEST_MOBILITY_MODEL_H
...
namespace ns3 {
	...
	class TestMobilityModel : public MobilityModel {
		...
		public:
			...
			uint32_t *GetFinishedPatrol(void);
			int GetFinishedPatrolSize(void);
